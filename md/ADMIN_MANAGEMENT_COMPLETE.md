...
1. **Setup Forms** → `/admin/forms`
   - Create Form 1, Form 2, etc.
   - Assign coordinators

2. **Create Classes** → `/admin/classes`
...
4. **Assign Students** → `/admin/student-assignment`
   - Assign students to their classes

5. **Assign Subjects to Classes** → `/admin/class-subject-assignment`
