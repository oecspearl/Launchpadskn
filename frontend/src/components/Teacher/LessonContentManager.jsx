...
import {
  calculateDuration, getContentIcon, formatFileSize, getYouTubeEmbedUrl,
  escapeHtml, buildTableHTML, formatRubricForDisplay, getSectionIcon
  ...
  return (
    <div className="lesson-content-manager-redesign">
      ...
      <ContentPreviewModal
        ...
        onEditContent={handleOpenModal}
        onOpenQuizBuilder={handleOpenQuizBuilder}
        onError={setError}
      />
